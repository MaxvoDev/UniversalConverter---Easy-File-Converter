export default function PrivacyPolicy() {
  return (
    <div className="space-y-12 text-md md:text-lg text-gray-500 pb-4 md:pb-8">
      ...
      <p>
        At Universal Converter, we are committed to safeguarding your privacy. This Privacy
      ...
      <p>
        By using Universal Converter, you agree to the practices outlined in this Privacy
